...
<html>
	...
	<body>
		<div align="center" class="log0">
			<span class="login_span">买家登陆</span>
		</div>
		<div class="log1">
			<form action="/MyProject_Demo_one/buyer_servlet/buyer_login" method="post" onsubmit="return checkForm()">
				...
				<a href="buyerRegister.jsp" class="register">注册</a>
			</form>
		</div>
		<div class="log2">
			<a href="../sellerView/sellerLogin.jsp" class="a_change">卖家入口</a>
		</div>
		<div class="log3">
