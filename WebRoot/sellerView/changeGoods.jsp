...
<body>
	...
	<div class="main">
		...
		<div class="right">
			...
			<div class="form">
				<form action="/MyProject_Demo_one/seller_servlet/goods_change"
					method="post">
					<div>
						<span>原商品名称:</span> <input type="text" name="goodsOldName"
							placeholder="请输入原来商品名称" />
					</div>
					<div>
						<span>新商品名称:</span> <input type="text" name="goodsName"
							placeholder="请输入新的商品名称" />
					</div>
					<div>
						<span>新商品价格:</span> <input type="text" name="goodsPrice"
							placeholder="请输入新的商品价格" />
					</div>
					<div>
						<span>新商品简介:</span>
