...
public class goods_add extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		goods.setGoodsName(request.getParameter("goodsName")); // 将卖家输入的商品名称放入新建的goods对象中
		goods.setGoodsPrice(request.getParameter("goodsPrice")); // 将卖家输入的商品价格放入新建的goods对象中
		goods.setGoodsText(request.getParameter("goodsText")); // 将卖家输入的商品简介放入新建的goods对象中
